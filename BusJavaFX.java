...
public class BusJavaFX /* extends Application */ implements AbstractBusView {
	...
	private Label lblNumOfPasengers = new Label("The bus has 0 passengers");
	...
	public BusJavaFX(Stage theStage) {
		...
		gpRoot.add(lblNumOfPasengers, 0, 3, 3, 1);
	...
	@Override
	public void updateNumOfPasengers(int size) {
		lblNumOfPasengers.setText("The bus has " + size + "pasengers");
